...
bibFile = '../data/myPub.bib'
def generateBib(cv=False,htmlC=True,separateJCW=False,bibfile='../data/myPub.bib'):#set false incase you dont want either one
    html=''
    htmlSeparated =''
    bibtex = ''
    htmlThesis=''
    ...
    for year in years:
        ...
        for entry in arranged[year]:
            ...
            if separateJCW:
                toAddHtml = '<b>['+cnt+']</b>&nbsp;'+arrangeAuthors(entry['author'])+', \"<paper>'+entry['title']+'</paper>\", '
                ...
                if entry['ENTRYTYPE']=='article':
                    if 'archiveprefix' in entry:
                        toAddHtml+=' '+entry['archiveprefix']+'. '+entry['volume']+'('+entry['number']+'), '+entry['year']+'.'
                        toAddBib+=entry['archiveprefix']+'. '+entry['volume']+'('+entry['number']+'), '+entry['year']+'. '
                    else:
                        toAddHtml+=' '+entry['journal']+'. '+entry['volume']+'('+entry['number']+'), '+entry['year']+'.'
                        toAddBib+=entry['journal']+'. '+entry['volume']+'('+entry['number']+'), '+entry['year']+'. '
                else:
                    toAddHtml+= ' In ' +entry['booktitle']+' ('+entry['series']+' '+entry['year']+').'
                ...
                try:
                    notes = entry['note']
                    toAddHtml+='<img src=\"images/prize.png\" style=\"width: 25px;align:middle;white-space:nowrap;\"><text style=\'color:red;align:middle;white-space:nowrap;\'>'+notes+'</text></img>&nbsp;'
                    toAddBib+='\\textcolor{red}{'+notes+'} '
                ...
                if abstract!='-':
                    toAddHtml+='<a data-toggle=\"collapse\" href=\"javascript:toggleDiv(\'P'+str(cnt)+'-abstract\')\">' \
                            ...
                            '2.5%;padding:0 2.5% 0 2.5%\">'+entry['abstract'].replace('{\%}','%')+'</div>'


                toAddHtml+='&nbsp;<a id="bibTag" href=\''+link+'\' style=\"color:#0074d9;font-weight:normal;\" target=\"_blank\">[doi]</a>'

                if entry['type'] == 'Journal':
                    dictJCW['JHtml']=dictJCW['JHtml']+toAddHtml+'</br></br>'
                    dictJCW['JBib'] = dictJCW['JBib']+toAddBib+'\\vspace{0.1in} \n\n'
                elif entry['type'] == 'Conference':
                    dictJCW['CHtml']=dictJCW['CHtml']+toAddHtml+'</br><BR>'
                    dictJCW['CBib'] = dictJCW['CBib']+toAddBib+'\\vspace{0.1in} \n\n'
                else:
                    dictJCW['WHtml']=dictJCW['WHtml']+toAddHtml+'</br><BR>'
                    dictJCW['WBib'] = dictJCW['WBib']+toAddBib+'\\vspace{0.1in} \n\n'
    ...
    if separateJCW:
        html=' <!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge,chrome=1\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1, maximum-scale=1\">    <meta http-equiv=\"Cache-Control\" content=\"no-cache, no-store, must-revalidate\" />' \
            ...
            '<div class=\"col-11\" id=\"thesis\"><div class=\"clearfix justified\"><h2 class=\"h2 upper\">Thesis</h2><b>[T1]</b> <Me>Sougata Sen</Me>, \"<paper>Fusing mobile, wearable and infrastructure sensing for immersive daily lifestyle analytics</paper>\", Ph.D. thesis advised by Prof. Archan Misra, at School of Information Systems, Singapore Management University, 2017. <A id=\"bibTag\" href=\"http://ink.library.smu.edu.sg/etd_coll_all/23/\" style=\"color:#0074d9;font-weight:normal;\">[link]</a>'\
            '</div></div><div class=\"col-11\" id=\"papers\"><div class=\"clearfix justified\"><BR><h2 class=\"h2 upper\">Journal, Conference and Workshop Publication</h2>'
        html+='<h3 class=\"h3 upper\">Journal Articles</h2>'+dictJCW['JHtml']+'<h3 class=\"h3 upper\">Conference Papers</h2>'+dictJCW['CHtml']+'<h3 class=\"h3 upper\">Workshop Papers and Consortia</h2>'+dictJCW['WHtml']
        ...
        html=' <!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge,chrome=1\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1, maximum-scale=1\">    <meta http-equiv=\"Cache-Control\" content=\"no-cache, no-store, must-revalidate\" />' \
            ...
            '</div></div><div class=\"col-11\" id=\"papers\"><div class=\"clearfix justified\"><BR><h2 class=\"h2 upper\">Journal, Conference and Workshop Publication</h2>'+html
        html+='</div></div><div class=\"col-11\" id=\"patents\"><div class=\"clearfix justified\"><h2 class=\"h2 upper\">Patents</h2><A id=\"bibTag\">[PT3]</A> Kumar Padmanabh, Puneet Gupta,<Me> Sougata Sen</Me>. <paper>System and method for forming application dependent dynamic data packet in wireless sensor networks</paper> (US Patent 8,588,192)<BR><BR><A id=\"bibTag\">[PT2]</A> Kumar Padmanabh, Adi M. R. Vanteddu, <Me>Sougata Sen</Me>, Amrit Kumar, Puneet Gupta, Lakshya Malhotra, Sunil Vuppala,<paper> Method and system for creating a virtual wireless sensor network</paper> (US Patent 8,649,298)<BR><BR><A id=\"bibTag\">[PT1]</A> <Me> Sougata Sen</Me>, Ketan Patil, Animikh Ghosh, Parag Chauhan, Kumar Padmanabh, <paper>Method and system to dynamically detect and form a master slave network</paper>. (US Patent 8,873,429)</div></div><div class=\"col-11\" id=\"book\"><div class=\"clearfix justified\"><h2 class=\"h2 upper\">Book Chapter</h2><A id=\"bibTag\">[B1]</A> Kumar Padmanabh,<Me> Sougata Sen</Me>, Sanjoy Paul. <paper>ZigBee versus Other Protocols and Standards</paper>. In ZigBee® Network Protocols and Applications (pp. 301-344). Auerbach Publications.</div></div></div></div></div></div></div></div></body></html>'
